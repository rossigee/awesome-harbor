...
- [Harbor CLI](https://github.com/goharbor/harbor-cli) - Official Harbor CLI
...
- [Crossplane Harbor Provider](https://github.com/globallogicuki/provider-harbor) Crossplane provider for Harbor based on terraform-provider-harbor
- [Crossplane Harbor Provider](https://github.com/rossigee/provider-harbor) - Crossplane provider for Harbor using native API calls
- [Pulumi Harbor Provider](https://github.com/pulumiverse/pulumi-harbor)- The Harbor Resource Provider lets you manage Harbor resources with Pulumi. This provider is using [Terraform Harbor Provider](https://github.com/goharbor/terraform-provider-harbor) under the hood so it has the same set of features.
...
- [Harbor Day 2 Operator](https://github.com/steadforce/harbor-day2-operator) - The harbor day2 operator is for automated managment of existing harbor instances using python harbor-api
...
## Archive
Deprecated or decomissioned projects, not recommended to use anymore.
- [Harbor Operator](https://github.com/goharbor/harbor-operator) - Day 1, Deploy and also operate Harbor on Kubernetes with this operator.
